...
public interface ConstantInfo {
	public static final Integer ADD_BOOK_CATEGORY_SAVE_MSG_CODE = 200;
	public static final Integer DELETE_BOOK_CATEGORY_SAVE_MSG_CODE = 200;
	public static final Integer UPDATE_BOOK_CATEGORY_SAVE_MSG_CODE = 200;
